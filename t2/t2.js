...
function countReports(filePath) {
    return __awaiter(this, void 0, void 0, function () {
        var fileStream, rl, safeReports, _a, rl_1, rl_1_1, line, reports, safe, i, reportsSlice, safe_1, e_1_1;
        var _b, e_1, _c, _d;
                ...
                case 3:
                    ...
                    if (safe) {
                        ...
                        for (i = 0; i < reports.length; i++) {
                            reportsSlice = reports.slice();
                            reportsSlice.splice(i, 1);
                            safe_1 = checkReports(reportsSlice);
                            if (safe_1) {
                                safeReports++;
                                break;
                            }
...
function checkReports(reports) {
    var direction = 0; // 0 -> not specified 1 -> asc 2 -> dsc
    var errors = 0;
